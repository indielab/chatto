...
<CardGrid>
  <LinkCard title="Permissions & Roles" href="/guides/planning/permissions/" description="The full permission resolution model, built-in roles, scopes, and common patterns." />
  <LinkCard title="Identity & Login" href="/guides/planning/identity-login/" description="Local accounts, external providers, SMTP email flows, and owner recovery." />
