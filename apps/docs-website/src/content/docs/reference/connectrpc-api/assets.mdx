...
| Field | Type | Description |
| --- | --- | --- |
| `asset` | [`MessageAttachment`](/reference/connectrpc-api/types/#chatto-api-v1-MessageAttachment) | Asset metadata and signed URLs. |
...
| Field | Type | Description |
| --- | --- | --- |
| `assets` | repeated [`MessageAttachment`](/reference/connectrpc-api/types/#chatto-api-v1-MessageAttachment) | Assets in first-seen request order. |
